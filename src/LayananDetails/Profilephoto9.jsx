...
import Images from '../assets/images/andre4.png';
...
const Profilephoto3 = () => {
  return (
      ...
      <div className='box-sizing rounded-xl mx-auto h-[1000px] w-[950px] mt-24 mb-10 bg-[#fff] drop-shadow-md'>
        <div className='relative position flex justify-items-stretch ml-[20px] mr-[37px] mt-2 '>
                                                                                                                                                  
            <img src={Images} alt="Wedding Photography" className="box-content  h-[250px] w-[200px] mx-[20px] mt-6" />
            <div>             
          <p className='text-center text-[30px] mt-6 font-bold'>Putri Yayang</p>
          </div>
          <div className='mt-[75px] ml-[120px]'>
          <p className='italic font-light '>
              <BiLogoGmail className='inline-block me-5' />
              putriyayang@gmail.com
            </p>                     
            <p>           
        ...
        <p>
          <a href="/layananporto10">Selengkapnya <FaAngleDoubleRight className='inline-block me-5' /></a>
        </p>
      </div>
      ...
      <div  className='flex justify-items-stretch ml-[20px] mr-[37px]  '>
        ...
        <Link to="" >
            <img src={Photo1} alt="" className="box-content rounded-lg h-[200px] w-[200px] mx-[20px]" /><ModalEditProfile/>
          </Link>

          <Link to="">
            <img src={Photo2} alt="" className="box-content rounded-lg h-[200px] w-[200px] mx-[20px]" /><ModalEditProfile2/>
          </Link>

          <Link to="">
            <img src={Photo3} alt="" className="box-content rounded-lg h-[200px] w-[200px] mx-[20px] " /><ModalEditProfile3/>
          </Link>

          <Link to="">
            <img src={Photo4} alt="" className="box-content rounded-lg h-[200px] w-[200px] mx-[20px]" /><ModalEditProfile4/>
          </Link>
      ...
      <div className='flex justify-between items-center px-8'>
        ...
        <p>
          <a href="/layananporto1010">Selengkapnya <FaAngleDoubleRight className='inline-block me-5' /></a>
        </p>
      </div>
      ...
      <div  className='flex justify-items-stretch ml-[20px] mr-[37px]  '>
        ...
        <Link to="/layananporto2" >
            <img src={Video1} alt="" className="box-content rounded-lg h-[200px] w-[200px] mx-[20px]" /><ModalEditProfile5/>
          </Link>

          <Link to="">
            <img src={Video2} alt="" className="box-content rounded-lg h-[200px] w-[200px] mx-[20px]" /><ModalEditProfile6/>
          </Link>

          <Link to="">
            <img src={Video3} alt="" className="box-content rounded-lg h-[200px] w-[200px] mx-[20px] " /><ModalEditProfile7/>
          </Link>

          <Link to="">
            <img src={Video4} alt="" className="box-content rounded-lg h-[200px] w-[200px] mx-[20px]" /><ModalEditProfile8/>
          </Link>
