  ...
  return (
      ...
      <div className='box-sizing rounded-xl mx-auto h-[1000px] w-[950px] mt-24 mb-10 bg-[#fff] drop-shadow-md'>
        <div className='relative position flex justify-items-stretch ml-[20px] mr-[37px] mt-2 '>
            ...
            <div>             
          <p className='text-center text-[30px] mt-6 font-bold'>Qomar Abdullah</p>
          </div>
          <div className='mt-[75px] ml-[50px]'>
          <p className='italic font-light '>
              <BiLogoGmail className='inline-block me-5' />
              qomarabdullah@gmail.com
            </p>                     
            <p>           
        ...
        <p>
          <a href="/layananporto12">Selengkapnya <FaAngleDoubleRight className='inline-block me-5' /></a>
        </p>
      </div>
      ...
      <div className='flex justify-between items-center px-8'>
        ...
        <p>
          <a href="/layananporto44">Selengkapnya <FaAngleDoubleRight className='inline-block me-5' /></a>
        </p>
      </div>

      <div  className='flex justify-items-stretch ml-[20px] mr-[37px]  '>
  
        <Link to="/layananporto1212" >
