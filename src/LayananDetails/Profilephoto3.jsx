  ...
  return (
      ...
      <div className='box-sizing rounded-xl mx-auto h-[1000px] w-[950px] mt-24 mb-10 bg-[#fff] drop-shadow-md'>
        <div className='relative flex justify-items-stretch ml-[20px] mr-[37px] mt-2 '>
            ...
            <div>             
          <p className='text-center text-[30px] mt-6 font-bold'>Bagus Rahmat</p>
          </div>
          <div className='mt-[75px] ml-[80px]'>
          <p className='italic font-light '>
              <BiLogoGmail className='inline-block me-5' />
              bagusrahmat@gmail.com
            </p>                     
            <p>           
        ...
        <p>
          <a href="/layananporto4">Selengkapnya <FaAngleDoubleRight className='inline-block me-5' /></a>
        </p>
      </div>
