...
<>
      <div className='box-sizing rounded-xl mx-auto h-[700px] w-[1150px] mt-24 mb-10 bg-[#fff] drop-shadow-md'>
        <p className='text-center text-3xl leading-normal font-bold font-inter'> Portofolio6</p>
...
const ModalEditProfile = () =>{
    ...
    return(
      <div>
        ...
        <div onClick={() => setOpenModal(true)} className="rounded-lg  text-white text-center w-[100px] hover:cursor-pointer mt-[10px] ml-[95px] mr-[3px] bg-[#EC0000] ">Details</div>
        <Modal show={openModal} size="md" onClose={onCloseModal} popup className="bg-transparent backdrop-blur-sm absolute pt-36">
          ...
          <Modal.Body className=" w-[1200px] h-[500px]">
            <div >
              ...
              <div className="flex ">
              <img src={Wedding} alt="" className="w-[300] rounded-lg" />
