...
const Intro = () => {
  return (
    <>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-5 justify-items-center mx-48 mb-10'>
        <div className='w-52 h-52 bg-white border-2 border-[red] flex flex-col justify-center gap-5 items-center text-center'>
