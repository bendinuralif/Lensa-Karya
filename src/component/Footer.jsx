...
<footer class="bg-black">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li class="mb-4">
                          <a href="aboutus" class="hover:underline">Tentang Kami</a>
                      </li>
                      <li class="mb-4">
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li>
                          <a href="#" class="hover:underline">Gabung</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="#" class="hover:underline">Fotografer</a>
                      </li>
                      <li class="mb-4">
                          <a href="#" class="hover:underline">Videografer</a>
                      </li>
                      <li class="mb-4">
                          <a href="portofolio" class="hover:underline">Portofolio</a>
                      </li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Lensa Karya</a>. All Rights Reserved.
          </span>
