...
const ModalPromo = () =>{
    ...
    return(
      <div>
        ...
        <div onClick={() => setOpenModal(true)} className="hover:cursor-pointer">Pengiklanan Akun</div>
        <Modal show={openModal} size="md" onClose={onCloseModal} popup className="bg-transparent backdrop-brightness-75 absolute pt-40 ">
          ...
          <Modal.Body>
            <div className="space-y-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center">Keuntungan Iklan</h3>
              <div>
              <div>
