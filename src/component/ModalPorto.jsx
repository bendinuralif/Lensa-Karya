...
import FileExplorerButton from "./FileUploadButton";
import ImageUploadButton from "./FileUploadButton";
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center p-8">
          ...
          <div className="flex flex-col pl-2">
            <p className="text-s my-1 text-gray-700">Teks di Sisi Kanan</p>
            <input
              type="text"
            ...
            <input
              type="text"
              className="w-full h-32 px-4 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
              placeholder="Masukkan teks di sini..."
            />
          </div>
        </div>
